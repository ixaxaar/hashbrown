...
/**
 * Controls whether error/exception reporting is allowed
 * @type {boolean}
 */
...
exports.notifyDevelopers = function(subj, errMsg, fn) {
    if (notifyDevs) {
        smtpTransport.sendMail({
...
exports.turnMeOn = function(cleanup) {
    if (notifyDevs) {
        process.on( 'SIGINT', function() {
            ...
            exports.notifyDevelopers("Error", "Received SIGINT, quitting",
                function(){
        ...
        process.on( 'SIGHUP', function() {
            ...
            exports.notifyDevelopers("Error", "Received SIGHUP, quitting",
                function(){
                    // some other closing procedures go here
                    if (cleanup) clanup();
                    process.exit();
