...
Connection.prototype.start = function() {
  ...
  if(this.socketOptions.ssl) {
    ...
    // addUser handlers
    this.connection.on("error", errorHandler(this));
    // addUser all handlers to the socket to manage it
...
Connection.prototype.close = function() {
  ...
  // addUser a dummy error listener to catch any weird last moment errors (and ignore them)
      ...
      if(self.bytesRead > 0 && self.sizeOfMessage > 0) {
        ...
        if(self.stubBuffer != null && self.stubBuffer.length > 0) {
          ...
          if(self.stubBuffer.length + data.length > 4) {
            ...
            // addUser the the bytes to the stub buffer
